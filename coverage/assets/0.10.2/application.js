    ...
    function launch(element) {
        ...
        if (!closing) {
            ...
            if (!open) {
                ...
                $box.css({visibility:'secret', display:'block', opacity:''});

                $loaded = $tag(div, 'LoadedContent', 'width:0; height:0; overflow:secret; visibility:secret');
